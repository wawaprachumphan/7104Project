...
# --------------------------
    ...
    with col2:
        st.image(
            "https://assets.herworld.co.uk/main_cms/2022/01/04/20220104-signs-crystals-main.jpg",
            caption="🧿 หินมงคล",
            use_container_width=True
        )
        st.markdown("หินมงคลช่วยเสริมพลังงานบวกและป้องกันสิ่งไม่ดี เหมาะสำหรับผู้ที่ต้องการความสงบและความสำเร็จในชีวิตทั้งด้านการงานและความรัก")

        if st.button("🛒", key="cart_stone"):
            st.success("เพิ่มหินมงคลลงในตะกร้าสินค้าแล้ว 🎉")
    ...
    with col3:
        ...
        if st.button("🛒", key="cart_candle"):
            st.success("เพิ่มเทียนหอมลงในตะกร้าสินค้าแล้ว 🎉")
