...
# --------------------------
    ...
    with col1:
        st.image(
            "https://raw.githubusercontent.com/wawaprachumphan/7104Project/main/%E0%B9%81%E0%B8%AB%E0%B8%A7%E0%B8%99%E0%B9%80%E0%B8%AA%E0%B8%A3%E0%B8%B4%E0%B8%A1%E0%B8%94%E0%B8%A7%E0%B8%87.png",
            caption="💍 แหวนเสริมดวง",
            use_container_width=True
        )
        st.markdown(
            """
            แหวนเสริมดวงนี้ออกแบบมาเพื่อเพิ่มพลังแห่งโชคลาภและความมั่นใจในตัวเอง
            เหมาะสำหรับผู้ที่ต้องการเสริมพลังงานบวกในด้านการงานและโชคลาภ เพื่อเปิดโอกาสใหม่ ๆ ในชีวิต
            """)
        if st.button("🛒 เพิ่มแหวนเสริมดวง", key="cart_ring"):
            st.success("เพิ่มแหวนเสริมดวงลงในตะกร้าสินค้าแล้ว")

    with col2:
        st.image(
            "https://raw.githubusercontent.com/wawaprachumphan/7104Project/main/%E0%B8%AA%E0%B8%A3%E0%B9%89%E0%B8%AD%E0%B8%A2%E0%B8%99%E0%B8%B3%E0%B9%82%E0%B8%8A%E0%B8%84.png",
            caption="📿 สร้อยนำโชค",
            use_container_width=True
        )
        st.markdown(
            """
            สร้อยนำโชคนี้ช่วยเสริมโชคลาภและพลังงานบวก
            เหมาะสำหรับผู้ที่ต้องการเสริมความมั่นใจและเสริมโชคในชีวิตประจำวัน
            """)
        if st.button("🛒 เพิ่มสร้อยนำโชค", key="cart_necklace"):
            st.success("เพิ่มสร้อยนำโชคลงในตะกร้าสินค้าแล้ว")

    with col3:
        st.image(
            "https://raw.githubusercontent.com/wawaprachumphan/7104Project/main/%E0%B9%80%E0%B8%97%E0%B8%B5%E0%B8%A2%E0%B8%99%E0%B8%AB%E0%B8%AD%E0%B8%A1%E0%B9%80%E0%B8%A3%E0%B8%B5%E0%B8%87%E0%B8%97%E0%B8%A3%E0%B8%B1%E0%B8%9A%E0%B8%AA%E0%B8%B1%E0%B8%9E.png",
            caption="🕯️ เทียนหอมเรียกทรัพย์",
            use_container_width=True
        )
        st.markdown(
            """
            เทียนหอมช่วยสร้างบรรยากาศผ่อนคลายและเพิ่มพลังบวก
            เหมาะสำหรับการทำสมาธิและเสริมโชคลาภในชีวิตประจำวัน
            """)
        if st.button("🛒 เพิ่มเทียนหอมเรียกทรัพย์", key="cart_candle"):
