...
# --------------------------
    ...
    st.write("""
    ✨ ช่วงเวลานี้ดวงของคุณโดดเด่นเรื่องโชคลาภทางการงานอย่างชัดเจน โอกาสใหม่ ๆ และความสำเร็จรอคุณอยู่ การเปิดรับความคิดใหม่ ๆ จะช่วยเพิ่มพูนโอกาสดี ๆ ที่เข้ามาในชีวิต ไม่ว่าจะเป็นการเจรจาธุรกิจ การโปรโมทตำแหน่ง หรือการได้รับโปรเจกต์สำคัญที่เพิ่มพูนรายได้และชื่อเสียง อย่าลืมรักษาความสมดุลระหว่างงานกับชีวิตส่วนตัว เพื่อให้พลังงานบวกนี้อยู่กับคุณได้นานขึ้น โชคชะตาจะนำพาคุณไปสู่ความสำเร็จที่เหนือความคาดหมาย
    """)
    ...
    with col1:
        ...
        st.write("แหวนเสริมดวงนี้ช่วยเสริมพลังแห่งโชคลาภและความมั่นใจในตัวเอง เหมาะกับผู้ที่ต้องการเปิดโอกาสทางการงานให้กว้างขึ้น ช่วยดึงดูดพลังบวกและโชคดีเข้ามาอย่างต่อเนื่อง")
    ...
    with col2:
        ...
        st.write("สร้อยนำโชคนี้ได้รับการออกแบบมาเพื่อช่วยเพิ่มเสน่ห์และความโดดเด่นในสายตาคนรอบข้าง เหมาะสำหรับคนที่ต้องการดึงดูดโอกาสและความสำเร็จในการงานและความสัมพันธ์")
    ...
    with col3:
        ...
        st.write("เทียนหอมเรียกทรัพย์นี้เหมาะสำหรับเสริมบรรยากาศที่ดีในบ้านหรือที่ทำงาน ช่วยเปิดช่องทางรับพลังบวกและโชคลาภ ให้การเงินไหลมาเทมาอย่างราบรื่นและมั่นคง")
