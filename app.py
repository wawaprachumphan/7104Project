...
# --------------------------
    ...
    with col3:
        st.image(
            "https://m.media-amazon.com/images/I/61LrxRGyynL._AC_UF1000,1000_QL80_.jpg",
            caption="📕 สมุดบันทึกโชคลาภ",
            use_container_width=True
        )
        st.markdown("สมุดบันทึกโชคลาภนี้ช่วยให้คุณบันทึกความฝันและเหตุการณ์สำคัญ พร้อมคำแนะนำเสริมโชคลาภจากหมอดูผู้เชี่ยวชาญ")

        if st.button("🛒", key="cart_journal"):
            st.success("เพิ่มสมุดบันทึกโชคลาภลงในตะกร้าสินค้าแล้ว 🎉")
